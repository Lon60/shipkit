...
// AppState enum for application states
type AppState int32
...
// StartComposeRequest contains UUID and compose YAML content
...
// StopAppRequest contains UUID for the app to stop
...
// RestartAppRequest contains UUID for the app to restart
...
func (x *RestartAppRequest) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
// UpdateComposeRequest contains UUID and updated compose YAML content
...
func (x *UpdateComposeRequest) Reset() {
	*x = UpdateComposeRequest{}
	mi := &file_proto_docker_control_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateComposeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateComposeRequest) ProtoMessage() {}

func (x *UpdateComposeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_docker_control_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateComposeRequest.ProtoReflect.Descriptor instead.
func (*UpdateComposeRequest) Descriptor() ([]byte, []int) {
	return file_proto_docker_control_proto_rawDescGZIP(), []int{3}
}

func (x *UpdateComposeRequest) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
func (x *UpdateComposeRequest) GetComposeYaml() string {
	if x != nil {
		return x.ComposeYaml
	}
	return ""
...
// GetStatusRequest contains UUID for status check
...
// ActionResult represents the result of an action (start, stop, restart, update)
...
// ContainerStatus represents the status of individual containers
...
const file_proto_docker_control_proto_rawDesc = "" +
	...
	"\x11RestartAppRequest\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\"M\n" +
	"\x14UpdateComposeRequest\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12!\n" +
	"\fcompose_yaml\x18\x02 \x01(\tR\vcomposeYaml\"&\n" +
	...
	"\n" +
	"error_code\x18\x03 \x01(\tR\terrorCode\"\xaa\x01\n" +
	"\tAppStatus\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12.\n" +
	...
	"\x05ports\x18\x04 \x03(\tR\x05ports*X\n" +
	"\bAppState\x12\v\n" +
	...
	"\aStopApp\x12\x1e.docker_control.StopAppRequest\x1a\x1c.docker_control.ActionResult\x12M\n" +
	"\n" +
	"RestartApp\x12!.docker_control.RestartAppRequest\x1a\x1c.docker_control.ActionResult\x12S\n" +
	"\rUpdateCompose\x12$.docker_control.UpdateComposeRequest\x1a\x1c.docker_control.ActionResult\x12H\n" +
	"\tGetStatus\x12 .docker_control.GetStatusRequest\x1a\x19.docker_control.AppStatusB)Z'github.com/shipkit/docker-control/protob\x06proto3"
...
var file_proto_docker_control_proto_goTypes = []any{
	...
	(*RestartAppRequest)(nil),    // 3: docker_control.RestartAppRequest
	(*UpdateComposeRequest)(nil), // 4: docker_control.UpdateComposeRequest
	(*GetStatusRequest)(nil),     // 5: docker_control.GetStatusRequest
	(*ActionResult)(nil),         // 6: docker_control.ActionResult
	(*AppStatus)(nil),            // 7: docker_control.AppStatus
	(*ContainerStatus)(nil),      // 8: docker_control.ContainerStatus
}
var file_proto_docker_control_proto_depIdxs = []int32{
	0, // 0: docker_control.AppStatus.state:type_name -> docker_control.AppState
	8, // 1: docker_control.AppStatus.containers:type_name -> docker_control.ContainerStatus
	...
	3, // 4: docker_control.DockerControlService.RestartApp:input_type -> docker_control.RestartAppRequest
	4, // 5: docker_control.DockerControlService.UpdateCompose:input_type -> docker_control.UpdateComposeRequest
	5, // 6: docker_control.DockerControlService.GetStatus:input_type -> docker_control.GetStatusRequest
	6, // 7: docker_control.DockerControlService.StartCompose:output_type -> docker_control.ActionResult
	6, // 8: docker_control.DockerControlService.StopApp:output_type -> docker_control.ActionResult
	6, // 9: docker_control.DockerControlService.RestartApp:output_type -> docker_control.ActionResult
	6, // 10: docker_control.DockerControlService.UpdateCompose:output_type -> docker_control.ActionResult
	7, // 11: docker_control.DockerControlService.GetStatus:output_type -> docker_control.AppStatus
