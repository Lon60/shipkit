    ...
    <div className="max-w-lg space-y-6 lg:space-y-8 text-center lg:text-left">
      ...
      <div className="space-y-3 lg:space-y-4">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground">
          Welcome to
          <span className="block text-primary mt-1 lg:mt-2">
            Shipkit
          </span>
        </h1>
      ...
      <div className="space-y-4 lg:space-y-6">
        <div className="space-y-2 lg:space-y-3">
          ...
          <p className="text-sm lg:text-base text-muted-foreground lg:ml-11">
            This is a fresh Shipkit instance. Create the first admin account to get started with container deployments.
          </p>
        </div>

        {/* Security Warning */}
        <div className="border-l-4 border-amber-400 bg-amber-50 dark:bg-amber-900/20 dark:border-amber-500 p-3 lg:p-4 rounded-r-lg">
          <div className="flex items-start space-x-2 lg:space-x-3">
            <svg className="w-4 h-4 lg:w-5 lg:h-5 text-amber-600 dark:text-amber-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L5.082 16.5c-.77.833.192 2.5 1.732 2.5z" />
            </svg>
            <div>
              <h4 className="font-medium text-amber-800 dark:text-amber-200 text-sm lg:text-base">
                Security Notice
              </h4>
              <p className="text-xs lg:text-sm text-amber-700 dark:text-amber-300 mt-1">
